...
import com.jinkeloid.yellowbananapixeldungeon.scenes.InterlevelScene;
import com.jinkeloid.yellowbananapixeldungeon.scenes.TitleScene;
...
//		}
		...
		if (!Dungeon.hero.isAlive()) {
			...
			addButton(new RedButton(TXT_START) {
                ...
                protected void onClick() {
                    Dungeon.hero = null;
                    YellowBananaPixelDungeon.challenges(Dungeon.challenges);
