...
import com.jinkeloid.yellowbananapixeldungeon.items.EquipableItem;
import com.jinkeloid.yellowbananapixeldungeon.items.armours.body.BodyArmorCloth;
import com.jinkeloid.yellowbananapixeldungeon.items.misc.OilLantern;
...
import com.jinkeloid.yellowbananapixeldungeon.actors.hero.Belongings;
import com.jinkeloid.yellowbananapixeldungeon.actors.hero.Hero;
import com.jinkeloid.yellowbananapixeldungeon.items.misc.Ankh;
import com.jinkeloid.yellowbananapixeldungeon.items.misc.Waterskin;
import com.jinkeloid.yellowbananapixeldungeon.items.misc.Gold;
...
import com.jinkeloid.yellowbananapixeldungeon.items.armours.shields.Shield;
import com.jinkeloid.yellowbananapixeldungeon.items.bags.Bag;
import com.jinkeloid.yellowbananapixeldungeon.items.bags.Keyring;
import com.jinkeloid.yellowbananapixeldungeon.items.bags.PotionSash;
import com.jinkeloid.yellowbananapixeldungeon.items.bags.ScrollHolder;
import com.jinkeloid.yellowbananapixeldungeon.items.bags.HerbPouch;
import com.jinkeloid.yellowbananapixeldungeon.items.bags.WandHolster;
import com.jinkeloid.yellowbananapixeldungeon.items.herbs.Herb;
...
import com.jinkeloid.yellowbananapixeldungeon.items.weapons.melee.MeleeWeapon;
import com.jinkeloid.yellowbananapixeldungeon.items.weapons.melee.MeleeWeaponLightOH;
import com.jinkeloid.yellowbananapixeldungeon.items.weapons.ranged.RangedWeapon;
import com.jinkeloid.yellowbananapixeldungeon.items.weapons.throwing.ThrowingWeapon;
...
import com.jinkeloid.yellowbananapixeldungeon.visuals.ui.Icons;
...
public class WndBag extends WndTabbed {
	...
	public WndBag( Bag bag, Listener listener, Mode mode, String title ) {
		...
		nCols = YellowBananaPixelDungeon.landscape() ? COLS_L : COLS_P;
		nRows = YellowBananaPixelDungeon.landscape() ? ROWS_L : ROWS_P ;
...
//        Ankh ankh = stuff.getItem( Ankh.class );
        ...
        if( YellowBananaPixelDungeon.landscape() ) {
		...
		protected boolean onLongClick() {
			if (listener == null && item.quickAction() != null) {
                ...
                if( QuickSlot.quickslot1.select() == null ) {
                    ...
                    YellowBananaPixelDungeon.scene().add(
